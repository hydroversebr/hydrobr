...
selectStations <- function(organizeResult,
  ...
  tryCatch({
    ...
    message("Nenhuma estão encontrada, verificar parâmetros de entrada. Caso persista, entrar em contato com desenvolver.")

    # (Opcional) Retorna NULL de forma invisível para não quebrar pipelines
